...
const Billing = () => (
  <section id='product' className={layout.sectionReverse}>
    <div className={layout.sectionImgReverse}>
      ...
      <div className='white__gradient rounded-full w-[50%] h-[50%] top-0 -left-1/2 absolute z-[3]' />
      <div className='pink__gradient rounded-full w-[50%] h-[50%] bottom-0 -left-1/2 absolute z-[3]' />
    </div>
