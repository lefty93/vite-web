  ...
  return (
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <h1 className="font-poppings font-semibold ss:text-[68px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full">Payment Method</h1>
      ...
      <div className={`flex-1 flex ${styles.flexCenter}`}>
        ...
        <div className="absolute z-[1] w-[45%] h-[80%] rounded-full bottom-40 white__gradient"></div>
